<template>
    <div id='logo' v-on:click="doNoise">
        <svg x="0" y="0" viewBox="0 0 206 94" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
                ...
                <g>
                    <path id="sl0" d="M187.2,18c-9.2,3.9,2.1,25.9,4,31.8c2,6,1.6,26.3,8.1,28.7c6.1,2.3,6.3-9.6,6-12.9c-0.8-7.3-4.5-14.2-6.7-21.2C197.6,41.6,190.4,16.6,187.2,18z" />
                    <path id="sl1" d="M153.1,28.8c-7.8,2-3.8,19.5-3,24.7c0.5,3.3,1,6.5,0.9,9.9c-0.1,4.1-1.9,11.2,0.3,15.1c2.9,5.1,7.2,0.3,9-3.7c2.8-6.3-0.3-13.3-1.7-19.7c-1.2-6-2.3-10.8-2.2-16.9C156.5,36,157.2,27.7,153.1,28.8z" />
                    <path id="sl2" d="M104.4,24.6c-2.8,2,2.2,20.1,2.6,23.6c0.4,3.4,1.3,6.9,1.2,10.4c-0.1,2.1-1.6,5.2-0.9,7.3c2,5.4,5.3,0.4,8.2-2.1c8.3-7.2,11.1-17,4.1-26.3C118,35.2,107.6,22.2,104.4,24.6z" />
                    <path id="sl3" d="M6,79.4c-2.4,1-5.7,2.8-5.9,5.7c-0.5,6.4,1.4,1,1.7,0.9c3.2-1.3,2.5-2.3,6.5-0.4c2.5,1.2,4.6,2.9,7,4c8,3.6,15.8,4,24.3,2.9c2.8-0.4,14.6,1.4,15.9-2.3c-1.7,4,0.5,3.2,4.1,3.4c2.6,0.1,5.7,0.4,8.3-0.1c1.4-0.3,9.4-3,9.3-3c0.2-0.1-7.6-7.4-8.7-8c-6.9-4.1-15.1-1.6-22.6-1.2C44,81.4,3.6,86.9,6.5,79.2C6.8,78.9,7.2,78.5,6,79.4z" />
                    <path id="sl4" d="M47.6,37.3c-7,4.5-15.7,5.6-23.7,6.6c-2.7,0.4-11.7-1-8.8,2.7c2.7,3.4,10.6,2.3,13.7,4.8c5.6,4.7-4.6,6.6-3.4,8.7c0.1,0.2,20.7-6.5,22.5-7c12.6,1,17-2.7,13.3-11.1C59.1,40.8,50.1,35.7,47.6,37.3z" />
                    <path id="sl5" d="M33.1,0.7c-2.9,0.9-5.8,2.2-8.8,2.5c-1.9,0.2-4.3-1-6.1-0.1c-4,2.1-0.5,3.3,2,4.6c7.3,3.9,14.2,9.8,22.8,9.5c5.7-0.2,19-2.8,12.5-10.7C51,1.1,39.5-1.3,33.1,0.7z" />
                </g>
            </defs>
            <g style="fill:#F7F7EF">
                <path id="sn0" d="M187.2,18c-9.2,3.9,2.1,25.9,4,31.8c2,6,1.6,26.3,8.1,28.7c6.1,2.3,6.3-9.6,6-12.9c-0.8-7.3-4.5-14.2-6.7-21.2C197.6,41.6,190.4,16.6,187.2,18z" />
                <path id="sn1" d="M153.1,28.8c-7.8,2-3.8,19.5-3,24.7c0.5,3.3,1,6.5,0.9,9.9c-0.1,4.1-1.9,11.2,0.3,15.1c2.9,5.1,7.2,0.3,9-3.7c2.8-6.3-0.3-13.3-1.7-19.7c-1.2-6-2.3-10.8-2.2-16.9C156.5,36,157.2,27.7,153.1,28.8z" />
                <path id="sn2" d="M104.4,24.6c-2.8,2,2.2,20.1,2.6,23.6c0.4,3.4,1.3,6.9,1.2,10.4c-0.1,2.1-1.6,5.2-0.9,7.3c2,5.4,5.3,0.4,8.2-2.1c8.3-7.2,11.1-17,4.1-26.3C118,35.2,107.6,22.2,104.4,24.6z" />
                <path id="sn3" d="M6,79.4c-2.4,1-5.7,2.8-5.9,5.7c-0.5,6.4,1.4,1,1.7,0.9c3.2-1.3,2.5-2.3,6.5-0.4c2.5,1.2,4.6,2.9,7,4c8,3.6,15.8,4,24.3,2.9c2.8-0.4,14.6,1.4,15.9-2.3c-1.7,4,0.5,3.2,4.1,3.4c2.6,0.1,5.7,0.4,8.3-0.1c1.4-0.3,9.4-3,9.3-3c0.2-0.1-7.6-7.4-8.7-8c-6.9-4.1-15.1-1.6-22.6-1.2C44,81.4,3.6,86.9,6.5,79.2C6.8,78.9,7.2,78.5,6,79.4z" />
                <path id="sn4" d="M47.6,37.3c-7,4.5-15.7,5.6-23.7,6.6c-2.7,0.4-11.7-1-8.8,2.7c2.7,3.4,10.6,2.3,13.7,4.8c5.6,4.7-4.6,6.6-3.4,8.7c0.1,0.2,20.7-6.5,22.5-7c12.6,1,17-2.7,13.3-11.1C59.1,40.8,50.1,35.7,47.6,37.3z" />
                <path id="sn5" d="M33.1,0.7c-2.9,0.9-5.8,2.2-8.8,2.5c-1.9,0.2-4.3-1-6.1-0.1c-4,2.1-0.5,3.3,2,4.6c7.3,3.9,14.2,9.8,22.8,9.5c5.7-0.2,19-2.8,12.5-10.7C51,1.1,39.5-1.3,33.1,0.7z" />
            </g>
        </svg>
    </div>
</template>
...
export default {
    ...
    methods: {
        resetSVG: function(d) {
            d = parseInt(d)
            for (let i = 0; i < 6; i++) {
                var tween0 = kute.fromTo(`#sn${i}`, { path: `#sa${i}` }, { path: `#sl${i}` }, { duration: 200, delay: (6 - i) * 20 + d }).start();
            }
        },
        doNoise: function(d) {
        ...
        initSVG: function(d) {
            d = parseInt(d)
            for (let i = 0; i < 6; i++) {
                var tween0 = kute.fromTo(`#sn${i}`, { path: `#sl${i}` }, { path: `#sa${i}` }, { duration: 200, delay: (6 - i) * 20 + d }).start();
            }
        }
    },
    watch: {
